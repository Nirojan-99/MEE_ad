...
export default function Home() {
  ...
  return (
    <Box height={height} sx={{ flexDirection: "row" }}>
      <div className=" flex-1 h-full w-full items-center justify-center flex lg:px-10 md:px-5 px-2">
        <Grid
          container
          spacing={2}
          gap={2}
          ...
          <Grid item xs={7} md={6} lg={2.5}>
            <div className="bg-[#526D82] shadow-md rounded-md py-2 px-4 flex items-center flex-col hover:scale-110 transition-all">
              ...
              <div className="w-full mt-3">
                <button className="w-full py-2 border rounded-md border-[#27374D] font-bold text-[#27374D] hover:bg-[#27374D] hover:text-white">
                  GET
                </button>
              </div>
            </div>
